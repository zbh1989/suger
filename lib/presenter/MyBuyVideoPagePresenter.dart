...
import '../pages/myBuyVideoPage.dart';
import '../pages/myCollection.dart';
import '../utils/PreferenceUtils.dart';

class MyBuyVideoPagePresenter extends BasePresenter<MyBuyVideoPageState>{

  /**
   * 查询购买视频
   * type 1 长视频  2 短视频
   */
  void getBuyVideos(int page,int limit,int type) async {
    ...
    try{
      ...
      await PreferenceUtils.instance.getString("userId").then((userId){
        ...
        requestFutureData<String>(
          Method.post,
          url: Api.HOST_URL + Api.MY_BUY_VIDEO,
