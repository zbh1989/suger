...
class ChargeVipPageState
    extends BaseState<ChargeVipPage, ChargeVipPagePresenter> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Image.asset(
                'lib/assets/images/pay_icon.png',
                width: 24,
                height: 24,
              ),
              Text(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('1.支付前请先绑定手机号，避免重新安装后账户损失！',
                    style: TextStyle(
                        fontSize: 12,
                        fontFamily: 'PingFang SC-Medium',
                        fontWeight: FontWeight.w400,
                        color: Color(0x80FFFFFF))),
                Text('2.点击“立即支付”后请尽快完成支付，超时支付无法到账，需要重新支付。',
                    style: TextStyle(
                        fontSize: 12,
                        fontFamily: 'PingFang SC-Medium',
                        fontWeight: FontWeight.w400,
                        color: Color(0x80FFFFFF))),
                Text('3.如果出现任何风险提示请不必担心，重新支付一次即可，并不会重复付款。',
                    style: TextStyle(
                        fontSize: 12,
                        fontFamily: 'PingFang SC-Medium',
                        fontWeight: FontWeight.w400,
                        color: Color(0x80FFFFFF))),
                Text('4.如果您使用了优惠券下单并为支付成功，优惠券将于2小时后返还账户。',
                    style: TextStyle(
                        fontSize: 12,
                        fontFamily: 'PingFang SC-Medium',
                        fontWeight: FontWeight.w400,
                ...
                children: [
                  ...
                  chooseItem == 1
                      ...
                      : Container(
                          decoration: BoxDecoration(
                            border:
                                Border.all(width: 1, color: Color(0xFFAC5AFF)),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Image.asset(
                    'lib/assets/images/wechat_pay.png',
                    width: 30,
                    height: 30,
                  ),
                  SizedBox(
