...
class ChargeGoldPage extends StatefulWidget {

  ChargeGoldPage({this.money,this.gold,this.extraGold,this.setPaymentOperation,this.orderNo,});
  ...
  @override
  ChargeGoldPageState createState() => ChargeGoldPageState();

}

class ChargeGoldPageState extends BaseState<ChargeGoldPage,ChargeGoldPagePresenter>{
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text(widget.gold.toString() +'金币',style: TextStyle(fontSize: 24,fontFamily: 'PingFang SC-Heavy',fontWeight: FontWeight.w400,color: Color(0xFFAC5AFF)),),
          ),

          Container(
            alignment: Alignment.center,
            margin: EdgeInsets.only(top: 8),
            child: Text('获赠'+ widget.extraGold.toString() +'金币',style: TextStyle(fontSize: 12,fontFamily: 'PingFang SC-Medium',fontWeight: FontWeight.w400,color: Color(0x80FFFFFF)),),
          ),
            ...
            child: Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.of(context).pop();
                    Toast.show('选择' + (chooseItem == 1 ? '支付宝' : '微信' ) + '支付金额' + widget.money.toString() + ',购买金币' + widget.gold.toString() + ',获赠金币' + widget.extraGold.toString());
                    mPresenter.createOrder(chooseItem,widget.money,widget.gold,widget.extraGold,widget.orderNo);
  ...
  @override
  ChargeGoldPagePresenter createPresenter() {
    return ChargeGoldPagePresenter();
  }
